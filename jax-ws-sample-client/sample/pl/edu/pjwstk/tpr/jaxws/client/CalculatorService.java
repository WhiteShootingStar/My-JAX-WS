 ...
 * 
 */
@WebServiceClient(name = "CalculatorService", targetNamespace = "http://jaxws.tpr.pjwstk.edu.pl/", wsdlLocation = "http://localhost:8081/jax-ws-sample/calculator?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CALCULATORSERVICE_QNAME = new QName("http://jaxws.tpr.pjwstk.edu.pl/", "CalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8081/jax-ws-sample/calculator?wsdl");
    ...
    public Calculator getCalculatorPort() {
        return super.getPort(new QName("http://jaxws.tpr.pjwstk.edu.pl/", "CalculatorPort"), Calculator.class);
    }
    ...
    public Calculator getCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxws.tpr.pjwstk.edu.pl/", "CalculatorPort"), Calculator.class, features);
    }
